const SectionDiv = ({ label, icons }) => {
  return (
    <div className="relative mt-11">
      ...
      <div className="min-h-30 w-full bg-[#202224] bg-linear-90 from-[#00AFFF] to-[#A27EFF] p-0.5 rounded-b-lg rounded-tr-lg">
        <div className="min-h-30 w-full bg-[#202224] rounded-b-lg rounded-tr-lg p-1.5">
          <div className="min-h-30 w-full bg-black rounded-lg flex flex-wrap gap-6 px-3 py-4 items-center">
            {icons}
          </div>
        </div>
      </div>
      <div className="absolute bg-[#202224] h-1 w-[172.5px] top-[37.5px] left-0.5"></div>
    </div>
  );
};
